...
public class WebArithmeticController { 
	...
	public String doMultiply(@RequestParam(defaultValue = "1") String factor1, 
                         ...
                         Model model) { 
	    String product = multiplicationService.multiply(factor1, factor2); // Triggering a call to the Multiplication Service multiply method. 
	    logger.info("Product: " + product); 
	    model.addAttribute("json", product); 
	    return "product"; // Return the name of the template to render the result. 
	} 
}