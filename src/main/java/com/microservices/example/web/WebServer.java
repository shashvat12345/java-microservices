...
public class WebServer { 
	...
	public static final String DIVISION_SERVICE_URL = "http://division-service"; // INPUT_REQUIRED {URL for the division service} 
	...
	public WebArithmeticController additionController() { 
		return new WebArithmeticController(additionService(), subtractionService(), divisionService()); 
	} 
	@Bean 
