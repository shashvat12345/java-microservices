...
public class WebServer { 
	...
	public static final String DIVISION_SERVICE_URL = "http://division-service"; // URL for Division Service 
	public static final String TRIGONOMETRY_SERVICE_URL = "http://trigonometry-service"; // URL for Trigonometry Service 
	...
	//Instancing the WebTrigonometryService and pass url of the trigonometry service 
	@Bean 
	public WebTrigonometryService trigonometryService() { 
		return new WebTrigonometryService(TRIGONOMETRY_SERVICE_URL); 
	} 
	//Instancing the controller. 
	@Bean 
	public WebArithmeticController additionController() { 
		return new WebArithmeticController(additionService(), subtractionService(), divisionService(), trigonometryService()); 
	} 
	@Bean 
