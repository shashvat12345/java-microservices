...
import com.microservices.example.rest.division.DivisionServer; // Added import for DivisionServer 
...
public class Main { 
	public static void main(String[] args) { 
		...
		} else if (serverName.equals("division")) { // Division server 
			DivisionServer.main(args); // Added case for Division server 
