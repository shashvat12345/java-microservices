...
public class AdditionController { 
    ...
    public String doAdd(@RequestParam(defaultValue = "0") String addend1, 
        ...
        int augend2; 
        try { 
            augend1 = Integer.valueOf(addend1); 
            augend2 = Integer.valueOf(addend2); 
        ...
        // Log the computed sum for better tracking 
        logger.info("Computed sum of " + augend1 + " and " + augend2 + " is " + sum); 
